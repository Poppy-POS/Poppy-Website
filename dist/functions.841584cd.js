...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/scripts/functions.js":[function(require,module,exports) {
function initialiseHeader() {
  if (mobileBeacon) {
    $('.header-theme-animation').css('width', '100%').css('transform', 'skew(0deg)');
  } else {
    $('.header-theme-animation').css('width', '90%').css('transform', 'skew(-20deg)');
  }
...
function galleryNext() {
  if (galleryNextLock || galleryLock) {
    return false;
  }
  ...
  if (windowWidth + positionRight == 0) {
    $('.arrow-right').addClass('hide');
    galleryNextLock = true;
  }
}

function galleryPrev() {
  if (galleryPrevLock || galleryLock) {
    return false;
  }
  ...
  if (positionRight - windowWidth == countGalleryImages * windowWidth - windowWidth - (countGalleryImages * windowWidth - windowWidth) * 2) {
...
function initialiseGallery() {
  ...
  windowWidth = $(window).width(); //copy to mobile gallery
...
},{}],"../../.nvm/versions/node/v10.15.2/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../.nvm/versions/node/v10.15.2/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/scripts/functions.js"], null)
//# sourceMappingURL=/functions.841584cd.js.map